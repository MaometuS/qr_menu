...
func (p *publicController) RemoveOrder(w http.ResponseWriter, r *http.Request) {
	...
	selectedItems, err = p.interactor.RemoveItem(context.WithValue(r.Context(), "db", p.db), item, selectedItems)
	if err != nil {
