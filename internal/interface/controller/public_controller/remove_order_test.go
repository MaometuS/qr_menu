...
func TestPublicController_RemoveOrder(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/remove_order/", nil)
	...
	req = httptest.NewRequest("GET", "/remove_order?id=2", nil)
	resp = httptest.NewRecorder()
	...
	req = httptest.NewRequest("GET", "/remove_order?id=2&menu_id=3", nil)
	resp = httptest.NewRecorder()
	...
	for i, el := range cases {
		...
		controller.RemoveOrder(el.resp, el.req)
