...
func TestItemRepository_GetOne(t *testing.T) {
	...
	cases := []testCase{
		...
		},
		{
			...
			output{
				&models.Item{int64(1), "name", "weight", float64(1), "additional_info", true, true, "image", int64(1), int64(1), 0},
				nil,
			},
		},
	}
	...
	for i, el := range cases {
		...
		if !reflect.DeepEqual(res, el.output.item) {
