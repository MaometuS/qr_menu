...
func (i *itemRepository) MoveDown(ctx context.Context, itemID int64) error {
	...
	t, err := db.Exec(ctx, "update items set order_param=order_param-1 where order_param = $1 and category_id = $2", order+1, categoryID)
	if err != nil {
		return err
	}
